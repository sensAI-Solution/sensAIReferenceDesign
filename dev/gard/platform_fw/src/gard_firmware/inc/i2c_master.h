 ...
 *    uint16_t pre_scaler            : calculate and set the prescaler to tune
 *the clock
 *
 * Return Value:
 *    int:
 ...
 *    uint8_t  *data_buffer          : pointer to data buffer storing the dare
 read back
 ...
 *			uint16_t address,
 *			uint8_t wr_data_size ,uint8_t * wr_data_buffer , uint8_t
 rd_data_size , uint8_t * rd_data_buffer);
 *
